          ...
          <div className="flex flex-col items-center w-full relative md:bg-transparent bg-white">
            ...
            <div className="md:hidden w-full relative">
              ...
              <div className="w-full flex items-center justify-center py-8">
                <a href="https://www.instagram.com/tremendo.santcugat/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center px-4 py-2 rounded-full shadow-md transition duration-300 hover:bg-black hover:text-white" style={buttonStyle}>
